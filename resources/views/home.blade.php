						...
						<div class="accordion" id="faq_accordion">
							<div class="accordion-item">
								...
								<div id="collapse1" class="accordion-collapse collapse show" aria-labelledby="heading1" data-bs-parent="#faq_accordion">
									<div class="accordion-body">
										NeCo EDC is an education development center dedicated to enhancing learning experiences through innovative programs, skill development, and educational resources. We focus on empowering students, teachers, and educational institutions with quality learning solutions.
									</div>
								</div>
							</div>							
							...
							<div class="accordion-item">
								...
								<div id="collapse2" class="accordion-collapse collapse" aria-labelledby="heading2" data-bs-parent="#faq_accordion">
									<div class="accordion-body">
										We provide a range of educational services, including teacher training, curriculum development, student mentorship, research support, and consultancy services for schools and educational institutions.
									</div>
								</div>
							</div>						
							...
							<div class="accordion-item">
								...
								<div id="collapse3" class="accordion-collapse collapse" aria-labelledby="heading3" data-bs-parent="#faq_accordion">
									<div class="accordion-body">
										You can enroll by visiting our website and exploring the available programs. Registration details, eligibility criteria, and application deadlines are provided for each program. You can also contact our team for personalized guidance.
									</div>
								</div>
							</div>				
							...
							<div class="accordion-item">
								...
								<div id="collapse4" class="accordion-collapse collapse" aria-labelledby="heading4" data-bs-parent="#faq_accordion">
									<div class="accordion-body">
										NeCo EDC is based in Kololo, Prince Charles Drive. You can reach us via email at <a href="mailto:info@necoedc.org">info@necoedc.org</a>  or call us at +256783797931 | +254701241860. You can also visit our website or follow our social media pages for updates.
									</div>
								</div>
							</div>
