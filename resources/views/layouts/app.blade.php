...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Urbanist:wght@400;500;600;700&amp;display=swap"
        rel="stylesheet">
    <!-- Icon CSS -->
                        ...
                        <div class="about-footer">
                            ...
                            <div class="fot-social">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <a
                                            href="https://www.instagram.com/necoedc?igsh=MXU5OXlzam93OGVncA%3D%3D&utm_source=qr"><i
            ...
            <div class="moeffect">
                <div class="fbulb_shape eitem" value=".5">
                    <svg fill="none" viewBox="0 0 90 90">
                        <g fill="#fff" fill-opacity=".28" clip-path="url(#clip0_2833_430)">
                            <path
                ...
                <div class="fshape2 eitem" value=".5">
                    <svg fill="none" viewBox="0 0 24 24">
                        <circle cx="12" cy="12" r="12" fill="#222854" />
                    </svg>
                </div>

                <div class="fshape3">
                    <svg fill="none" viewBox="0 0 132 199">
                        <circle cx="99.5" cy="99.5" r="98.5" stroke="#fff" stroke-opacity=".05" stroke-width="2" />
                    </svg>
                </div>

                <div class="fshape4 spinning">
                    <svg fill="none" viewBox="0 0 82 92">
                        <path stroke="#fff" stroke-opacity=".05" stroke-width="3"
                ...
                <div class="fshape5 eitem">
                    <svg fill="none" viewBox="0 0 199 199">
                        <circle cx="99.5" cy="99.5" r="99.5" fill="#222854" fill-opacity=".05" />
                    </svg>
                </div>
